...
`,g=a.default.styled(u.default)`
  ...
  margin: 0;
  border: none;
`,h=a.default.createElement;var v=({isExpanded:e=!0,input:t={display:!0},header:r={},messages:a=[],onMessage:n,onClick:o})=>{const s=h(y,{isExpanded:e,className:"ziiir-conversation"},a.sort((e,t)=>e.createdtime>t.createdtime).map(e=>((e,t,r,a)=>h(i.default,{key:e,createdtime:e,avatar:a,fromUser:r},t))(e.createdtime,e.text,"user"===e.from,e.avatar)));let l="ziiir.com";const u=e=>{const t=e.target.value||"";"Enter"===e.key&&t.length>0&&(n&&n(t),e.target.value="")};return t.display&&(l=h(g,{className:"ziir-input",onKeyUp:u,placeholder:t.placeholder||"Your message"})),h(c,{className:e?"isexpanded":void 0,onClick:o},h(p,null,r.text||""),s,h(m,null,l))};t.default=v},function(e,t,r){"use strict";var a;Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;var n=((a=r(15))&&a.__esModule?a:{default:a}).default;t.default=n},function(e,t,r){"use strict";Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;var a=o(r(0)),n=o(r(1));function o(e){return e&&e.__esModule?e:{default:e}}const s=a.default.styled("div")`
  padding: 1.2em;
...
cursor:pointer;
`;s.defaultProps={theme:n.default};var l=s;t.default=l},function(e,t,r){"use strict";Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;var a,n=(a=r(6))&&a.__esModule?a:{default:a},o=r(8),s=r(3),l=r(9);var i=async(e,t)=>{const[r,a]=(0,l.useSelector)(e=>[e.messenger.isOpen,e.messenger.header]);let i=r;const u=(0,s.useRef)(null),d=()=>{i=!i;const e=u.current;e.classList.toggle("isclosed"),e.classList.toggle("isopen")},f=await(0,n.default)(),c=(0,o.styled)(f.Messenger,{onMessage:e=>{t(e)},onClick:e=>{e.stopPropagation()},header:a})`
    width: 100%;
    max-width: 600px;
    height: 80%;
  `,p=(0,o.styled)("div",{ref:u,className:"ziiircom-messenger is"+(i?"open":"closed"),onClick:d},c)`
    display: flex;
    position: fixed;
    top: 0;
    left: 0;
...
//# sourceMappingURL=main.345daf78f05eed963256.js.map