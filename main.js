...
`;f.defaultProps={theme:d.default};const p=n.default.styled(o.default)`
  border-radius: 12px 12px 0 0;
`,y=n.default.styled(i.default)`
  border-radius: 0 0 12px 12px;
`,m=n.default.styled(s.default)`
...
`,g=n.default.styled(u.default)`
  ...
  border: none;
  outline:none;
`,h=n.default.createElement;var v=({isExpanded:e=!0,input:t={display:!0},header:r={},messages:n=[],onMessage:a,onClick:o})=>{const s=h(m,{isExpanded:e,className:"ziiir-conversation"},n.sort((e,t)=>e.createdtime>t.createdtime).map(e=>((e,t,r,n)=>h(l.default,{key:e,createdtime:e,avatar:n,fromUser:r},t))(e.createdtime,e.text,"user"===e.from,e.avatar)));let i="ziiir.com";const u=e=>{const t=e.target.value||"";"Enter"===e.key&&t.length>0&&(a&&a(t),e.target.value="")};return t.display&&(i=h(g,{className:"ziir-input",onKeyUp:u,placeholder:t.placeholder||"Your message"})),h(f,{className:e?"isexpanded":void 0,onClick:o},h(p,null,r.text||""),s,h(y,null,i))};t.default=v},function(e,t,r){"use strict";var n;Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;var a=((n=r(23))&&n.__esModule?n:{default:n}).default;t.default=a},function(e,t,r){"use strict";Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;var n=o(r(0)),a=o(r(1));function o(e){return e&&e.__esModule?e:{default:e}}const s=n.default.styled("div")`
  padding: 1.2em;
...
cursor:pointer;
`;s.defaultProps={theme:a.default};var i=s;t.default=i},function(e,t,r){"use strict";Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;var n,a=(n=r(7))&&n.__esModule?n:{default:n},o=r(9),s=r(3),i=r(10);var l=async(e,t)=>{const[r,n,l]=(0,i.useSelector)(e=>[e.messenger.isOpen,e.messenger.header,e.messenger.input]);let u=r;const d=(0,s.useRef)(null),c=()=>{u=!u;const e=d.current;e.classList.toggle("isclosed"),e.classList.toggle("isopen")},f=await(0,a.default)(),p=(0,o.styled)(f.Messenger,{onMessage:e=>{t(e)},onClick:e=>{e.stopPropagation()},header:n,input:l})`
    width: 100%;
    max-width: 600px;
    height: 80%;
  `,y=(0,o.styled)("div",{ref:d,className:"ziiircom-messenger is"+(u?"open":"closed"),onClick:c},p)`
    display: flex;
    position: fixed;
    top: 0;
    left: 0;
  ...
  `,m=(0,o.styled)(f.FAButton,{className:"ziiircom-messenger-fab",onClick:c})`
    position: absolute;
    right: 32px;
    bottom: 32px;
    z-index: 9;
  `;return(0,o.styled)("div",{className:"ziiircom-messenger-frame"},y,m)`
    position: fixed;
    top: 0;
    left: 0;
    width: 100vw;
