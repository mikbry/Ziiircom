...
`;f.defaultProps={theme:u.default};const p=a.default.styled(s.default)`
  border-bottom: ${e=>"1px solid "+e.theme.palette.border};
  border-radius: ${e=>`${e.theme.radius}px ${e.theme.radius}px 0 0`};
`;p.defaultProps={theme:u.default};const m=a.default.styled(i.default)`
...
`;m.defaultProps={theme:u.default};const h=a.default.styled(o.default)`
  transform-origin: center bottom 0px;
  scroll-behavior: smooth;
`,g=a.default.styled(d.default)`
  width: 100%;
  padding: 4px;
  margin: 0;
  border: none;
  outline: none;
`,y=a.default.createElement;var v=({isExpanded:e=!0,input:t={display:!0},header:r={},messages:a=[],onMessage:n,onClick:s,onAction:o,hideDate:i=!1})=>{const{text:d="",...u}=r,c=y(h,{isExpanded:e,className:"ziiir-conversation"},a.sort((e,t)=>e.created_time>t.created_time).map((e,t,r)=>{const a=r[t-1],n=!!a&&a.from===e.from&&e.created_time-a.created_time<2e3,s=r[t+1],d=!!s&&s.from===e.from&&s.created_time-e.created_time<2e3;return((e,t,r,a,n,s,o,i,d)=>y(l.default,{key:e,createdtime:e,avatar:a,fromUser:r,onAction:n,hideDate:s,hasPrevious:o,hasNext:i,quickReplies:d},t))(e.created_time,e.text,"user"===e.from,e.avatar,o,i,n,d,e.quick_replies)}));let v="ziiir.com";const b=e=>{const t=e.target.value||"";"Enter"===e.key&&t.length>0&&(n&&n(t),e.target.value="")};return t.display&&(v=y(g,{className:"ziir-input",onKeyUp:b,placeholder:t.placeholder||"Your message"})),y(f,{className:e?"isexpanded":void 0,onClick:s},y(p,u,d),c,y(m,null,y("div",null,"Powered by ",y("a",{href:"https://ziiir.com"},"ziiir.com")),v))};t.default=v},function(e,t,r){"use strict";var a;Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;var n=((a=r(23))&&a.__esModule?a:{default:a}).default;t.default=n},function(e,t,r){"use strict";Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;var a=s(r(0)),n=s(r(1));function s(e){return e&&e.__esModule?e:{default:e}}const o=a.default.styled("div")`
  padding: 1.2em;
...
`;o.defaultProps={theme:n.default};var i=o;t.default=i},function(e,t,r){"use strict";var a;Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;var n=((a=r(25))&&a.__esModule?a:{default:a}).default;t.default=n},function(e,t,r){"use strict";Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;var a=s(r(0)),n=s(r(1));function s(e){return e&&e.__esModule?e:{default:e}}const o=a.default.styled("header")`
  ...
  padding-right: 0.3em;
  display: flex;
`;o.defaultProps={theme:n.default};const i=a.default.styled("button")`
width:24px;
height:24px;
...
cursor:pointer;
`;l.defaultProps={theme:n.default};const d=a.default.createElement;var u=({children:e,closeButton:t})=>{let r=d(o,null,e[0]);if(t){const a=d(i,{onClick:t.onClose},d(l));r=d(o,null,a,d("span",null,e[0]))}return r};t.default=u},function(e,t,r){"use strict";var a;Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;var n=((a=r(27))&&a.__esModule?a:{default:a}).default;t.default=n},function(e,t,r){"use strict";Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;var a=s(r(0)),n=s(r(1));function s(e){return e&&e.__esModule?e:{default:e}}const o=a.default.styled("div")`
  padding: 0px;
  background: ${e=>e.theme.palette.background};
  display: flex;
  flex-direction: column;
...
`;o.defaultProps={theme:n.default};var i=o;t.default=i},function(e,t,r){"use strict";Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;var a=r(2),n=o(r(0)),s=o(r(1));function o(e){return e&&e.__esModule?e:{default:e}}const i=(e,t="none")=>e.button&&e.button.border?e.button.border:t,l=e=>e.button&&e.button.background?e.button.background:e.surface,d=e=>e.button&&e.button.color?e.button.color:e.onSurface,u=n.default.styled("div")`
  display: flex;
  flex-direction: row;
  width: 100%;
  max-width: 80%;
...
`;u.defaultProps={theme:s.default};const c=n.default.styled("div")`
  display: flex;
  flex-flow: row wrap;
  width: 100%;
  & > button {
...
`;c.defaultProps={theme:s.default};const f=n.default.styled("span")`
  z-index: 3;
  flex-shrink: 0;
  width: 40px;
  height: 40px;
...
`,m=n.default.createElement;var h=({createdtime:e,avatar:t,fromUser:r=!0,children:n,onAction:s,hideDate:o=!1,hasPrevious:i=!1,hasNext:l=!1,quickReplies:d})=>{const h=(0,a.friendlyDate)(e);let g=n,y=n;Array.isArray(g)&&([g]=n),"string"==typeof g&&(g.indexOf("/>")>0||g.indexOf("</")>0||g.indexOf("/&gt;")>0||g.indexOf("&lt;/")>0)?(g={__html:g},y=void 0):g=void 0;return m(u,{fromUser:r,"created-time":e,hasPrevious:i,hasNext:l},t&&(l?m(f):m(p,{src:t.src,alt:t.name})),m("div",{onClick:e=>{"BUTTON"===e.target.tagName&&s(e.target.tagName,e.target.textContent)}},m("p",{dangerouslySetInnerHTML:g},y),!o&&!d&&!l&&m("span",null,h),d&&m(c,{onClick:e=>{e.target.parentNode.style.display="none"}},d.map(e=>m("button",{key:e.title},e.title)))))};t.default=h},function(e,t,r){"use strict";var a;Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;var n=((a=r(32))&&a.__esModule?a:{default:a}).default;t.default=n},function(e,t,r){"use strict";Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;var a=s(r(0)),n=s(r(1));function s(e){return e&&e.__esModule?e:{default:e}}const o=a.default.styled("input")`
  font-size: 1em;
  margin: 0.6em;
  padding: 0.3em 1em;
  border-radius: 3px;
