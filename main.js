...
`,m=n.default.createElement;var y=({createdtime:e,avatar:t,fromUser:r=!0,children:n,onAction:s,hideDate:o=!1,hasPrevious:i=!1,hasNext:l=!1,quickReplies:u})=>{const y=(0,a.friendlyDate)(e);let h=n,g=n;Array.isArray(h)&&([h]=n),"string"==typeof h&&(h.indexOf("/>")>0||h.indexOf("</")>0||h.indexOf("/&gt;")>0||h.indexOf("&lt;/")>0)?(h={__html:h},g=void 0):h=void 0;return m(d,{fromUser:r,"created-time":e,hasPrevious:i,hasNext:l},t&&(l?m(f):m(p,{src:t.src,alt:t.name})),m("div",{onClick:e=>{"BUTTON"===e.target.tagName&&s(e.target.tagName,e.target.textContent)}},m("p",{dangerouslySetInnerHTML:h},g),!o&&!u&&!l&&m("span",null,y),u&&m(c,{onClick:e=>{e.target.parentNode.style.display="none"}},u.map(e=>m("button",{key:e.title},e.title)))))};t.default=y},function(e,t,r){"use strict";var a;Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;var n=((a=r(32))&&a.__esModule?a:{default:a}).default;t.default=n},function(e,t,r){"use strict";Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;var a=s(r(0)),n=s(r(1));function s(e){return e&&e.__esModule?e:{default:e}}const o=a.default.styled("input")`
  font-size: 1em;
  margin: 0.6em;
  padding: 0.3em 1em;
  border-radius: 3px;
