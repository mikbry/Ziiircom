...
`;c.defaultProps={theme:s.default};const p=a.default.styled("div")`
  display: flex;
  flex-flow: row wrap;
  width: 100%;
  & > button {
...
`;p.defaultProps={theme:s.default};const m=a.default.styled("span")`
  z-index: 3;
  flex-shrink: 0;
  width: 40px;
  height: 40px;
...
`,g=a.default.createElement;var y=({createdtime:e,avatar:t,fromUser:r=!0,children:a,onAction:s=(()=>{}),hideDate:i=!1,hasPrevious:l=!1,hasNext:d=!1,quickReplies:u,template:y})=>{const v=(0,n.friendlyDate)(e);let b=a,x=a;Array.isArray(b)&&([b]=a),"string"==typeof b&&(b.indexOf("/>")>0||b.indexOf("</")>0||b.indexOf("/&gt;")>0||b.indexOf("&lt;/")>0)?(b={__html:b},x=void 0):b=void 0;const _=e=>{e.preventDefault();e.target.parentNode.style.display="none"},w=(e,t)=>{e.stopPropagation(),e.preventDefault(),s("BUTTON",t);e.target.parentNode.parentNode.style.display="none"};let M;u?M=g(p,{},u.map(e=>g("button",{key:e.title,className:"ziiir-quickreply",onClick:_},e.title))):i||d||(M=g("span",null,v));const $=g(c,{fromUser:r,"created-time":e,hasPrevious:l,hasNext:d},t&&(d?g(m):g(h,{src:t.src,alt:t.name})),g("div",{onClick:e=>{"BUTTON"===e.target.tagName&&s(e.target.tagName,e.target.textContent)}},g("p",{dangerouslySetInnerHTML:b},x),M));return y?g(f,{},$,g(o.default,{...y,onAction:w})):$};t.default=y},function(e,t,r){"use strict";var n;Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;var a=((n=r(33))&&n.__esModule?n:{default:n}).default;t.default=a},function(e,t,r){"use strict";Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;var n=s(r(0)),a=s(r(1)),o=s(r(34));function s(e){return e&&e.__esModule?e:{default:e}}const i=n.default.styled("div")`
    font-size: 1em;
    display: flex;
    width: 100%;
    flex-direction: row;
  ...
  & > div {
   ...
   margin-bottom: 8px;
   margin-top: 16px;
   border-radius: ${e=>e.theme.message.radius}px;
  }
`;i.defaultProps={theme:a.default},l.defaultProps={theme:a.default};const d=n.default.styled("div")`
   width: calc(100% + 18px);
   margin-left: -8px;
   overflow-x: auto;
`;i.defaultProps={theme:a.default};const u=n.default.createElement;var c=({elements:e,onAction:t=(()=>{}),alt:r=!0})=>{const n=[];e.forEach((e,r)=>{const a=u(o.default,{onAction:(e,n,a)=>{t(e,n,r,a)},...e});n.push(a)});let a=i;r&&(a=l);const s=u(a,void 0,n);return u(d,void 0,s)};t.default=c},function(e,t,r){"use strict";var n;Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;var a=((n=r(35))&&n.__esModule?n:{default:n}).default;t.default=a},function(e,t,r){"use strict";Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;var n=o(r(0)),a=o(r(1));function o(e){return e&&e.__esModule?e:{default:e}}const s=n.default.styled("div")`
   font-size: 1em;
   display: flex;
   width: fit-content; 
   flex-direction: column;
