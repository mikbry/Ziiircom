...
`;o.defaultProps={theme:s.default};var i=o;t.default=i},function(e,t,r){"use strict";Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;var a=(e={},t)=>{const{fonts:r={}}=e,{text:a={},heading:s={}}=r,n=document.createElement("link");n.setAttribute("rel","stylesheet"),n.setAttribute("href",a.url||"https://fonts.googleapis.com/css?family=Raleway:400,700&display=swap"),n.setAttribute("type","text/css");const o=document.createElement("link");o.setAttribute("rel","stylesheet"),o.setAttribute("href",s.url||"https://fonts.googleapis.com/css?family=Raleway:400,700&display=swap"),o.setAttribute("type","text/css");const[i]=document.getElementsByTagName("head");i.appendChild(n),i.appendChild(o);const[l]=document.getElementsByClassName(t);l.style.cssText=`font-family: ${a.name&&a.name+", "||""}sans-serif;`};t.default=a},function(e,t,r){"use strict";Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;var a,s=(a=r(7))&&a.__esModule?a:{default:a},n=r(9),o=r(3),i=r(10);var l=async(e,t,r,a)=>{const[l,u={},d]=(0,i.useSelector)(e=>[e.messenger.isOpen,e.messenger.header,e.messenger.input]);let c=l;const f=(0,o.useRef)(null),p=()=>{c=!c;const e=f.current;e.classList.toggle("isclosed"),e.classList.toggle("isopen"),e.firstChild.classList.remove("isexpanded")};u.closeButton&&(u.closeButton.onClose=p);const m=await(0,s.default)(),h=(0,n.styled)(m.Messenger,{messages:e,onMessage:e=>{t(e)},onClick:e=>{e.stopPropagation()},onAction:r,header:u,input:d,hideDate:a})`
  ...
  `,y=(0,n.styled)(m.FAButton,{className:"ziiircom-messenger-fab",onClick:p})`
    position: absolute;
    right: 32px;
    bottom: 32px;
    z-index: 9;
  `;return(0,n.styled)("div",{className:"ziiircom-messenger-frame"},g,y)``};t.default=l}]);
