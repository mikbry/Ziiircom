...
`,g=a.default.styled(d.default)`
  ...
  border: none;
  outline: none;
`,y=a.default.createElement;var v=({isExpanded:e=!0,input:t={display:!0},header:r={},messages:a=[],onMessage:s,onClick:n,onAction:o,hideDate:i=!1})=>{const{text:d="",...u}=r,c=y(h,{isExpanded:e,className:"ziiir-conversation"},a.sort((e,t)=>e.created_time>t.created_time).map((e,t,r)=>{const a=r[t-1],s=!!a&&a.from===e.from&&e.created_time-a.created_time<2e3,n=r[t+1],d=!!n&&n.from===e.from&&n.created_time-e.created_time<2e3;return((e,t,r,a,s,n,o,i,d)=>y(l.default,{key:e,createdtime:e,avatar:a,fromUser:r,onAction:s,hideDate:n,hasPrevious:o,hasNext:i,quickReplies:d},t))(e.created_time,e.text,"user"===e.from,e.avatar,o,i,s,d,e.quick_replies)}));let v="ziiir.com";const b=e=>{const t=e.target.value||"";"Enter"===e.key&&t.length>0&&(s&&s(t),e.target.value="")};return t.display&&(v=y(g,{className:"ziir-input",onKeyUp:b,placeholder:t.placeholder||"Your message"})),y(f,{className:e?"isexpanded":void 0,onClick:n},y(p,u,d),c,y(m,null,y("div",null,"Powered by ",y("a",{href:"https://ziiir.com"},"ziiir.com")),v))};t.default=v},function(e,t,r){"use strict";var a;Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;var s=((a=r(23))&&a.__esModule?a:{default:a}).default;t.default=s},function(e,t,r){"use strict";Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;var a=n(r(0)),s=n(r(1));function n(e){return e&&e.__esModule?e:{default:e}}const o=a.default.styled("div")`
  padding: 1.2em;
