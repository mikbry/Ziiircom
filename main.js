...
`;i.defaultProps={theme:s.default};const l=n.default.styled("div")`
  display: flex;
  flex-direction: row;
  width: 100%;
  & > button {
...
`;l.defaultProps={theme:s.default};const u=n.default.styled("span")`
  z-index: 3;
  flex-shrink: 0;
  width: 40px;
  height: 40px;
...
`,c=n.default.createElement;var f=({createdtime:e,avatar:t,fromUser:r=!0,children:n,onAction:s,hideDate:o=!1,hasPrevious:f=!1,hasNext:p=!1,quickReplies:m})=>{const h=(0,a.friendlyDate)(e);let y=n,g=n;Array.isArray(y)&&([y]=n),"string"==typeof y&&(y.indexOf("/>")>0||y.indexOf("</")>0||y.indexOf("/&gt;")>0||y.indexOf("&lt;/")>0)?(y={__html:y},g=void 0):y=void 0;return c(i,{fromUser:r,"created-time":e,hasPrevious:f,hasNext:p},t&&(p?c(u):c(d,{src:t.src,alt:t.name})),c("div",{onClick:e=>{"BUTTON"===e.target.tagName&&s(e.target.tagName,e.target.textContent)}},c("p",{dangerouslySetInnerHTML:y},g),!o&&!m&&!p&&c("span",null,h),m&&c(l,{},m.map(e=>c("button",{key:e.title},e.title)))))};t.default=f},function(e,t,r){"use strict";var a;Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;var n=((a=r(32))&&a.__esModule?a:{default:a}).default;t.default=n},function(e,t,r){"use strict";Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;var a=s(r(0)),n=s(r(1));function s(e){return e&&e.__esModule?e:{default:e}}const o=a.default.styled("input")`
  font-size: 1em;
  margin: 0.6em;
  padding: 0.3em 1em;
  border-radius: 3px;
