...
cursor:pointer;
`;s.defaultProps={theme:a.default};var i=s;t.default=i},function(e,t,r){"use strict";Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0;var n,a=(n=r(7))&&n.__esModule?n:{default:n},o=r(9),s=r(3),i=r(10);var l=async(e,t,r)=>{const[n,l,u]=(0,i.useSelector)(e=>[e.messenger.isOpen,e.messenger.header,e.messenger.input]);let d=n;const c=(0,s.useRef)(null),f=()=>{d=!d;const e=c.current;e.classList.toggle("isclosed"),e.classList.toggle("isopen")},p=await(0,a.default)(),m=(0,o.styled)(p.Messenger,{messages:e,onMessage:e=>{t(e)},onClick:e=>{e.stopPropagation()},onAction:r,header:l,input:u})`
    width: 100%;
    max-width: 600px;
    height: 80%;
  `,y=(0,o.styled)("div",{ref:c,className:"ziiircom-messenger is"+(d?"open":"closed"),onClick:f},m)`
    display: flex;
    position: fixed;
    top: 0;
    left: 0;
  ...
  `,g=(0,o.styled)(p.FAButton,{className:"ziiircom-messenger-fab",onClick:f})`
    position: absolute;
    right: 32px;
    bottom: 32px;
    z-index: 9;
  `;return(0,o.styled)("div",{className:"ziiircom-messenger-frame"},y,g)`
    position: fixed;
    top: 0;
    left: 0;
    width: 100vw;
